...
PARAM$finalmodel$num_iterations <- 42
PARAM$finalmodel$learning_rate <- 0.09984
PARAM$finalmodel$feature_fraction <- 0.5368
PARAM$finalmodel$min_data_in_leaf <- 2697
PARAM$finalmodel$num_leaves <- 73
