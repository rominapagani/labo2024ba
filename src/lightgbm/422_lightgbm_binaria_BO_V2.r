...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_data_in_leaf", lower = 10L, upper = 3000L),
  makeIntegerParam("envios", lower = 7000L, upper = 12000L),
  makeNumericParam("lambda_l2", lower = 0.0, upper = 10.0)  # Añadido el parámetro lambda
)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  # Registro la importancia de variables
