...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(201905, 201906, 201907, 201908, 201909,
                                        ...
                                        202003, 20204, 202005, 202006, 202007, 
                                        202008, 202009, 202010, 202011, 202012, 
                                        202101, 202102, 202103, 202104, 202105)
  
  param_local$train$training <- c(201907, 201908, 201909,
                                  201910, 201911, 201912, 202001, 202002, 
                                  202003, 20204, 202005, 202006, 202007, 
                                  202008, 202009, 202010, 202011, 202012, 
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2213_HT_lightgbm_SEMI.r"
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    ...
    semillerio = 10,   # cantidad de semillas finales
    repeticiones_exp = 1 )
